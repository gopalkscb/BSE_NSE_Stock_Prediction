...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_root_swimc_nhzbb_189:not(#\9) {
...
.awsui_anchor-list_swimc_nhzbb_221:not(#\9) {
  list-style: none;
  margin-block: 0;
  margin-inline: 0;
  padding-block: 0;
...
.awsui_anchor-list_swimc_nhzbb_221:not(#\9)::before {
  content: "";
...
.awsui_anchor-item_swimc_nhzbb_245:not(#\9) {
  font-size: var(--font-size-body-m-a7nh2n, 14px);
  line-height: var(--line-height-body-m-2mh3ke, 20px);
...
.awsui-motion-disabled .awsui_anchor-item_swimc_nhzbb_245:not(#\9), .awsui-mode-entering .awsui_anchor-item_swimc_nhzbb_245:not(#\9) {
  animation: none;
  transition: none;
}
.awsui_anchor-item--active_swimc_nhzbb_265:not(#\9) {
  position: relative;
}
.awsui_anchor-item--active_swimc_nhzbb_265:not(#\9)::before {
  content: "";
...
.awsui_anchor-link_swimc_nhzbb_283:not(#\9) {
  font-size: var(--font-size-body-m-a7nh2n, 14px);
  line-height: var(--line-height-body-m-2mh3ke, 20px);
...
.awsui-motion-disabled .awsui_anchor-link_swimc_nhzbb_283:not(#\9), .awsui-mode-entering .awsui_anchor-link_swimc_nhzbb_283:not(#\9) {
  animation: none;
  transition: none;
}
body[data-awsui-focus-visible=true] .awsui_anchor-link_swimc_nhzbb_283:not(#\9):focus {
  outline: thin dotted;
...
.awsui_anchor-link_swimc_nhzbb_283:not(#\9):hover {
  color: var(--color-text-accent-n1kmht, #006ce0);
}
.awsui_anchor-link_swimc_nhzbb_283:not(#\9):focus {
  outline: none;
}
.awsui_anchor-link_swimc_nhzbb_283:not(#\9):hover, .awsui_anchor-link_swimc_nhzbb_283:not(#\9):focus {
  text-decoration: none;
}
.awsui_anchor-link--active_swimc_nhzbb_325:not(#\9) {
...
.awsui_anchor-link-text_swimc_nhzbb_332:not(#\9) {
  display: block;
}

.awsui_anchor-link-info_swimc_nhzbb_336:not(#\9) {
