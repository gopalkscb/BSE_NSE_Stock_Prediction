...
export const AfterMainSlotImplementationInternal = ({ appLayoutState, appLayoutProps }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(AppLayoutBuiltInErrorBoundary, { appLayoutPart: "tools" },
...
export const AfterMainSlotImplementation = (props) => (React.createElement(AppLayoutBuiltInErrorBoundary, { appLayoutPart: "after-main-slot" },
