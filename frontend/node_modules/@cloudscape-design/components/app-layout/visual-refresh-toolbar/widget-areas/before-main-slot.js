...
export const BeforeMainSlotImplementationInternal = ({ toolbarProps, appLayoutState, appLayoutProps, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        !toolbarProps && !!activeAiDrawerId && (React.createElement("div", { className: styles['pseudo-toolbar'], style: {
                insetBlockStart: (_b = (_a = appLayoutState.appLayoutInternals) === null || _a === void 0 ? void 0 : _a.verticalOffsets) === null || _b === void 0 ? void 0 : _b.toolbar,
            } },
            React.createElement("div", { className: styles['pseudo-toolbar-content'] }))),
