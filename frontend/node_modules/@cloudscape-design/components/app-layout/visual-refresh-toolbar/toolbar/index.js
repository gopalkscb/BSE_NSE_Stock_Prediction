...
toolbarProps = {}, featureNotificationsProps, }) {
    var _a, _b, _c;
    ...
    return (React.createElement(ToolbarSlot, { ref: ref, className: clsx(((aiDrawer === null || aiDrawer === void 0 ? void 0 : aiDrawer.trigger) || !!activeAiDrawerId) && styles['with-ai-drawer'], {
            [testutilStyles['mobile-bar']]: isMobile,
        }), style: {
            insetBlockStart: verticalOffsets.toolbar,
        } },
        React.createElement(AppLayoutBuiltInErrorBoundary, { appLayoutPart: "left-drawer-trigger" },
        ...
        React.createElement(ToolbarContainer, { hasAiDrawer: !!activeAiDrawerId },
            hasNavigation && (React.createElement("nav", { ...navLandmarkAttributes, className: clsx(styles['universal-toolbar-nav']) },
                React.createElement(AppLayoutBuiltInErrorBoundary, { appLayoutPart: "toolbar-trigger-nav" },
            ...
            (breadcrumbs || discoveredBreadcrumbs) && (React.createElement(AppLayoutBuiltInErrorBoundary, { appLayoutPart: "breadcrumbs" },
            ...
            ((drawers === null || drawers === void 0 ? void 0 : drawers.length) ||
                ...
                React.createElement(AppLayoutBuiltInErrorBoundary, { appLayoutPart: "toolbar-triggers" },
