...
export function AppLayoutGlobalAiDrawerImplementation({ appLayoutInternals, show, activeAiDrawer, aiDrawerProps, }) {
    ...
    return (React.createElement(AppLayoutBuiltInErrorBoundary, { appLayoutPart: "left-drawer" },
                        ...
                        React.createElement("div", { className: styles['drawer-content'] },
                            React.createElement("header", { className: styles['drawer-content-header'] },
                                React.createElement("div", { className: styles['drawer-content-header-content'] },
                                    React.createElement(AppLayoutBuiltInErrorBoundary, { renderFallback: () => React.createElement("div", null), appLayoutPart: "left-drawer-header" }, (_c = activeAiDrawer === null || activeAiDrawer === void 0 ? void 0 : activeAiDrawer.header) !== null && _c !== void 0 ? _c : React.createElement("div", null)),
                            ...
                            React.createElement(AppLayoutBuiltInErrorBoundary, { appLayoutPart: "left-drawer-content" },
