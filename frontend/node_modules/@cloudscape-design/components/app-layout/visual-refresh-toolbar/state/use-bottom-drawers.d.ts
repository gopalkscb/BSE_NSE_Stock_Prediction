...
export declare function useBottomDrawers({
  onBottomDrawerFocus,
  expandedDrawerId,
  setExpandedDrawerId,
  drawersOpenQueue
  ...
  bottomDrawers: (import("../..").AppLayoutProps.Drawer & {
    ...
    onToggle?: import("../../../types/events").NonCancelableEventHandler<import("../../../internal/plugins/controllers/drawers").DrawerStateChangeParams>;
    headerActions?: ReadonlyArray<import("../../..").ButtonGroupProps.Item>;
    exitExpandedModeTrigger?: React.ReactNode;
    onToggleFocusMode?: import("../../../types/events").NonCancelableEventHandler<{
      isExpanded: boolean;
    }>;
  })[];
  ...
  onActiveBottomDrawerChange: (drawerId: string | null, {
