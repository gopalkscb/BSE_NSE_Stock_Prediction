...
export declare function handleMenuSelection(tokens: readonly PromptInputProps.InputToken[], selectedOption: {
  value: string;
  label?: string;
}, menuId: string, isPinned: boolean, activeTrigger: PromptInputProps.TriggerToken): MenuSelectionResult;
export {};