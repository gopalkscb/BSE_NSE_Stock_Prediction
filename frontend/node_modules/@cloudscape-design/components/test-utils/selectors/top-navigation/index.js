...
class TopNavigationWrapper extends selectors_1.ComponentWrapper {
    ...
    findOverflowMenu() {
        return (0, selectors_1.createWrapper)().findComponent(`.${styles_selectors_js_3.default['overflow-menu-drawer']}`, OverflowMenu);
    }
}
...
class OverflowMenu extends selectors_1.ComponentWrapper {
    findDismissButton() {
        return this.findByClassName(styles_selectors_js_3.default['overflow-menu-dismiss-button']);
    }
    findBackButton() {
        return this.findByClassName(styles_selectors_js_3.default['overflow-menu-back-button']);
    }
    findTitle() {
        return this.findByClassName(styles_selectors_js_3.default['overflow-menu-header-text--title']);
    }
    findDescription() {
        return this.findByClassName(styles_selectors_js_3.default['overflow-menu-header-text--secondary']);
    }
    findUtility(index) {
