...
const styles_selectors_js_5 = require("../../../dropdown/styles.selectors.js");
const styles_selectors_js_6 = require("../../../input/styles.selectors.js");
const styles_selectors_js_7 = require("../../../internal/components/dropdown-status/styles.selectors.js");
...
class ButtonDropdownWrapper extends dom_1.ComponentWrapper {
    ...
    findFilteringInput() {
        var _a, _b;
        return (_b = (_a = this.findOpenDropdown()) === null || _a === void 0 ? void 0 : _a.findComponent(`.${styles_selectors_js_6.default['input-container']}`, index_js_2.default)) !== null && _b !== void 0 ? _b : null;
    }
    /**
    ...
    findFooterRegion() {
        var _a, _b;
        return (_b = (_a = this.findOpenDropdown()) === null || _a === void 0 ? void 0 : _a.findByClassName(styles_selectors_js_7.default.root)) !== null && _b !== void 0 ? _b : null;
    }
    openDropdown() {
        (0, utils_dom_1.act)(() => {
