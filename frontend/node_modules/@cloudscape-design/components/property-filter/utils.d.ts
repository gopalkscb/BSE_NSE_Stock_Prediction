...
import { InternalFilteringOption, InternalFilteringProperty, InternalToken, InternalTokenGroup } from './internal-interfaces';
export declare function isInternalToken(tokenOrGroup: InternalToken | InternalTokenGroup): tokenOrGroup is InternalToken;
export declare function isInternalTokenGroup(tokenOrGroup: InternalToken | InternalTokenGroup): tokenOrGroup is InternalTokenGroup;
