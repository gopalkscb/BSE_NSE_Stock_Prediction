declare const customCSSPropertiesMap: {
  ...
  dropdownContentBorderColor: string;
  dropdownContentBorderWidth: string;
  dropdownContentBorderRadius: string;
  modalCustomWidth: string;
  modalCustomHeight: string;
  ...
  styleSliderTrackBackgroundColor: string;
  styleSliderRangeBackgroundDefault: string;
  styleSliderRangeBackgroundActive: string;
  styleSliderHandleBackgroundDefault: string;
