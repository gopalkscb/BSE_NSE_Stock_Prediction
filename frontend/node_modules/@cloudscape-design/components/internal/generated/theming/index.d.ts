...
export declare interface TypedOverride {
  ...
  tokens: {
    ...
    colorBackgroundLayoutAiDrawer?: GlobalValue | TypedModeValueOverride<'light' | 'dark'>;
    ...
    colorTextButtonInlineLinkHover?: GlobalValue | TypedModeValueOverride<'light' | 'dark'>;
    colorTextButtonIconHover?: GlobalValue | TypedModeValueOverride<'light' | 'dark'>;
