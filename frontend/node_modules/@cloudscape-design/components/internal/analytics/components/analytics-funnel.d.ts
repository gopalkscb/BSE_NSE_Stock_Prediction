...
import { FunnelStartProps, FunnelStepProps, StepConfiguration } from '../interfaces';
...
export declare const AnalyticsFunnelSubStep: ({
  children,
  subStepIdentifier,
  subStepErrorContext
}: AnalyticsFunnelSubStepProps) => JSX.Element;
export {};