...
@layer awsui-base-theme {
  body {
    ...
    --color-text-button-inline-link-hover-nwj2vw:var(--color-text-button-normal-hover-gusgyv);
    --color-text-button-icon-hover-hqqurk:var(--color-text-interactive-hover-6naf7i);
