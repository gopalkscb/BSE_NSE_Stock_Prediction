...
exports.computeFilteringOptions = computeFilteringOptions;
...
function computeFilteringOptions(allItems, filteringProperties) {
    ...
    return filteringProperties.reduce((acc, property) => {
        ...
        for (const item of allItems) {
            addOption('' + (0, property_filter_js_1.fixupFalsyValues)(item[property.key]));
        }
        return acc;
    }, []);
}
...
function createActions({ dispatch, collectionRef, }) {
    return {
        ...
        setMultiSorting(sortingColumns) {
            var _a;
...
function createSyncProps(options, { filteringText, sortingColumns, selectedItems, expandedItems, currentPageIndex, propertyFilteringQuery, groupSelection, }, actions, collectionRef, { pagesCount, actualPageIndex, allItems, totalItemsCount, expandableRows, filteringOptions, }) {
        ...
        collectionProps: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ empty }, (options.sorting
            ? options.sorting.multiColumn
                ...
                : {
                    ...
                    sortingColumn: (_a = sortingColumns[0]) === null || _a === void 0 ? void 0 : _a.sortingColumn,
                    sortingDescending: (_b = sortingColumns[0]) === null || _b === void 0 ? void 0 : _b.isDescending,
                }
            ...
            : {})), { ref: collectionRef, firstIndex: 1, totalItemsCount }), (((_e = options.pagination) === null || _e === void 0 ? void 0 : _e.pageSize)
            ? {
