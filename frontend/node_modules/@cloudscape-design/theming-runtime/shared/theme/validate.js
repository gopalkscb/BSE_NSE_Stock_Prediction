...
export function validateOverride(override, themeable, availableContexts) {
    ...
    var completeTokens = ((_a = override.referenceTokens) === null || _a === void 0 ? void 0 : _a.color)
        ? // Reference tokens should override existing tokens
         __assign(__assign({}, fromEntries(tokensEntries)), processReferenceTokens(override.referenceTokens.color)) : fromEntries(tokensEntries);
    return {
